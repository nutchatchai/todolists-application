...
const navigator = createMaterialTopTabNavigator({
    buttomPage1:{screen:stackPage1,navigationOptions: {header:null}},
    buttomPage2:{screen:stackPage2,navigationOptions: {header:null}},
    buttomPage3:{screen:stackPage3,navigationOptions: {header:null}},
  })
